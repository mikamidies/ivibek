...
onMounted(async () => {
    try {
        ...
        if (deadlinesResult.success) {
            ...
            message.error(
                deadlinesResult.error || "Не удалось загрузить дедлайны",
            );
        }
                ...
                <div class="essay__form">
                    <div class="essay__selects">
                        ...
                        <div v-if="showWordLimit" class="essay__select-item">
                            <label for="word-limit"
                                >{{ t("essay-lab.word-limit") }} *</label
                            >
                            <a-select
                                id="word-limit"
